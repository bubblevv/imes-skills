...
1. Verify target identity, then read the one `IOBDZD` route by visible form name: unique `MC/BH/MARK`, tables, header/detail keys, tabs, and non-blank `FORMAT`.
